...
import { fallbackData, ConsolaData } from './constants';
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-xl font-medium">01 23 45 67 89</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-xl font-medium">contact@consolamenuiserie.fr</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-xl font-medium">123 Rue de l'Artisanat, <br />75000 Paris</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-2">
            ...
            <p className="text-secondary max-w-sm leading-relaxed">
              Depuis 1945, nous façonnons le bois avec passion pour créer des espaces de vie uniques et restaurer la beauté de notre patrimoine.
            </p>
          </div>
...
import { getConsolaContent } from './services/geminiService';

export default function App() {
  const [data, setData] = useState<ConsolaData>(fallbackData);
  const [isLoading, setIsLoading] = useState(true);

  useEffect(() => {
    const fetchData = async () => {
      try {
        const content = await getConsolaContent();
        if (content && Array.isArray(content.services)) {
          setData(content);
        }
      } catch (error) {
        console.error("Error fetching Consola content:", error);
      } finally {
        setIsLoading(false);
      }
    };
    ...
    return (
      <div className="h-screen w-full flex items-center justify-center bg-cream">
        <div className="flex flex-col items-center">
          ...
          />
          <span className="text-secondary font-serif italic">Chargement de l'excellence...</span>
        </div>
      </div>
    );
  }
